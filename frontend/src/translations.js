...
export const translations = {
  en: {
    ...
    modalBody:
      "Submit a row to Quanton Market. We validate TON fields, rarity band, and attach your Telegram profile when the Mini App exposes it.",
    ariaCloseModal: "Close",
    formListingName: "Listing name",
    formCollection: "Collection",
    phListingName: "e.g. Diamond Bear",
    phCollection: "e.g. Telegram Gifts",
    formImageUrl: "Image URL",
    phImageUrl: "https://example.com/image.png",
    formPriceTon: "Price (TON)",
    formFloorTon: "Floor (TON)",
    formRarity: "Rarity (1-100)",
    phRarity: "1-100",
    cancelBtn: "Cancel",
    submitListing: "Submit listing",
    submittingLabel: "Submitting...",

    errNameRequired: "Listing name is required.",
    errCollectionRequired: "Collection is required.",
    errImageRequired: "Image URL is required.",
    errPricePositive: "Price in TON must be a number greater than 0.",
    errFloorPositive: "Floor price in TON must be a number greater than 0.",
    errRarityInt: "Rarity must be a whole number from 1 to 100.",
    successToastSubmit:
      "Listing saved to Quanton Market. Status is pending until cleared.",
  ...
  ru: {
    ...
    modalTitle: "Новый лот",
    modalBody:
      "Отправьте строку в Quanton Market. Проверяем поля TON, диапазон редкости и, если Mini App отдаёт профиль, прикрепляем Telegram‑пользователя.",
    ariaCloseModal: "Закрыть",
    formListingName: "Название лота",
    formCollection: "Коллекция",
    phListingName: "напр. Diamond Bear",
    phCollection: "напр. Telegram Gifts",
    formImageUrl: "URL изображения",
    phImageUrl: "https://example.com/image.png",
    formPriceTon: "Цена (TON)",
    formFloorTon: "Флор (TON)",
    formRarity: "Редкость (1-100)",
    phRarity: "1-100",
    cancelBtn: "Отмена",
    submitListing: "Отправить лот",
    submittingLabel: "Отправка...",

    errNameRequired: "Укажите название лота.",
    errCollectionRequired: "Укажите коллекцию.",
    errImageRequired: "Нужен URL изображения.",
    errPricePositive: "Цена в TON должна быть числом больше 0.",
    errFloorPositive: "Флор в TON должен быть числом больше 0.",
    errRarityInt: "Редкость — целое число от 1 до 100.",
    successToastSubmit:
      "Лот сохранён в Quanton Market. Статус pending до проверки.",
