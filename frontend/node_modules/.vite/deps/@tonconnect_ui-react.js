...
function delay(timeout2, options) {
  return __awaiter(this, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
      var _a2, _b2;
      if ((_a2 = void 0) === null || _a2 === void 0 ? void 0 : _a2.aborted) {
        reject(new TonConnectError("Delay aborted"));
        return;
      }
      const timeoutId = setTimeout(() => resolve(), timeout2);
      (_b2 = void 0) === null || _b2 === void 0 ? void 0 : _b2.addEventListener("abort", () => {
...
var BridgeGateway = class {
  ...
  registerSession(options) {
    return __awaiter(this, void 0, void 0, function* () {
      var _a2, _b2, _c2;
      try {
        (_a2 = this.analytics) === null || _a2 === void 0 ? void 0 : _a2.emitBridgeClientConnectStarted({
        ...
        (_b2 = this.analytics) === null || _b2 === void 0 ? void 0 : _b2.emitBridgeClientConnectEstablished({
          bridge_connect_duration: bridgeConnectDuration,
          trace_id: options === null || options === void 0 ? void 0 : options.traceId
        });
      } catch (error) {
        (_c2 = this.analytics) === null || _c2 === void 0 ? void 0 : _c2.emitBridgeClientConnectError({
          trace_id: options === null || options === void 0 ? void 0 : options.traceId,
  ...
  pause() {
    this.eventSource.dispose().catch((e2) => logError(`Bridge pause failed, ${e2}`));
  }
  unPause() {
    return __awaiter(this, void 0, void 0, function* () {
  ...
  close() {
    return __awaiter(this, void 0, void 0, function* () {
      yield this.eventSource.dispose().catch((e2) => logError(`Bridge close failed, ${e2}`));
    });
  }
  ...
  messagesHandler(e2) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        const bridgeIncomingMessageRaw = JSON.parse(e2.data);
...
function isExpiredPendingConnectionHttpRaw(connection) {
  var _a2;
  return Date.now() - ((_a2 = connection.createdAt) !== null && _a2 !== void 0 ? _a2 : 0) > CONNECTION_HTTP_EXPIRATION_TIME;
}
...
function UUIDv7(options, buf, offset) {
  ...
  let bytes;
  if (options) {
    bytes = v7Bytes((_c2 = (_a2 = options.random) !== null && _a2 !== void 0 ? _a2 : (_b2 = options.rng) === null || _b2 === void 0 ? void 0 : _b2.call(options)) !== null && _c2 !== void 0 ? _c2 : rng(), options.msecs, options.seq, buf, offset);
  } else {
    const now = Date.now();
    const rnds = rng();
...
function updateV7State(state2, now, rnds) {
  var _a2, _b2;
  (_a2 = state2.msecs) !== null && _a2 !== void 0 ? _a2 : state2.msecs = -Infinity;
  (_b2 = state2.seq) !== null && _b2 !== void 0 ? _b2 : state2.seq = 0;
  if (now > state2.msecs) {
...
function waitForSome(promises, count) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return new Promise((resolve) => {
      promises.forEach((p2, index) => {
        Promise.resolve(p2).then((value) => ({ status: "fulfilled", value })).catch((reason) => ({ status: "rejected", reason })).then((result) => {
...
var BridgeProvider = class _BridgeProvider {
  ...
  constructor(connectionStorage, walletConnectionSource, analyticsManager) {
    ...
    this.analytics = (_a2 = this.analyticsManager) === null || _a2 === void 0 ? void 0 : _a2.scoped();
  }
  connect(message, options) {
    var _a2, _b2;
    const traceId = (_a2 = options === null || options === void 0 ? void 0 : options.traceId) !== null && _a2 !== void 0 ? _a2 : UUIDv7();
    const abortController = createAbortController(options === null || options === void 0 ? void 0 : options.signal);
    (_b2 = this.abortController) === null || _b2 === void 0 ? void 0 : _b2.abort();
  ...
  restoreConnection(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const openingDeadlineMS = (_c2 = options === null || options === void 0 ? void 0 : options.openingDeadlineMS) !== null && _c2 !== void 0 ? _c2 : this.defaultOpeningDeadlineMS;
  ...
  sendRequest(request, optionsOrOnRequestSent) {
    ...
    (_a2 = options.traceId) !== null && _a2 !== void 0 ? _a2 : options.traceId = UUIDv7();
    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
      var _a3, _b2;
      ...
      try {
        (_a3 = this.analytics) === null || _a3 === void 0 ? void 0 : _a3.emitBridgeClientMessageSent({
        ...
        (_b2 = options === null || options === void 0 ? void 0 : options.onRequestSent) === null || _b2 === void 0 ? void 0 : _b2.call(options);
  ...
  gatewayListener(bridgeIncomingMessage) {
    return __awaiter(this, void 0, void 0, function* () {
      var _a2, _b2, _c2;
      const traceId = (_a2 = bridgeIncomingMessage.traceId) !== null && _a2 !== void 0 ? _a2 : UUIDv7();
      let walletMessage;
      try {
        ...
        (_b2 = this.analytics) === null || _b2 === void 0 ? void 0 : _b2.emitBridgeClientMessageDecodeError({
      ...
      (_c2 = this.analytics) === null || _c2 === void 0 ? void 0 : _c2.emitBridgeClientMessageReceived({
        bridge_url: this.session.bridgeUrl,
        client_id: this.session.sessionCrypto.sessionId,
        wallet_id: bridgeIncomingMessage.from,
...
var InMemoryStorage = class _InMemoryStorage {
  ...
  getItem(key) {
    var _a2;
    return (_a2 = this.storage[key]) !== null && _a2 !== void 0 ? _a2 : null;
  }
  key(index) {
    var _a2;
    ...
    return (_a2 = keys[index]) !== null && _a2 !== void 0 ? _a2 : null;
  }
  removeItem(key) {
...
function getOriginWithPath() {
  var _a2, _b2, _c2, _d2;
  const origin = (_b2 = (_a2 = getWindow()) === null || _a2 === void 0 ? void 0 : _a2.location) === null || _b2 === void 0 ? void 0 : _b2.origin;
  const path = (_d2 = (_c2 = getWindow()) === null || _c2 === void 0 ? void 0 : _c2.location) === null || _d2 === void 0 ? void 0 : _d2.pathname;
  if (origin && path) {
    return origin + path;
  }
  return "";
...
var InjectedProvider = class _InjectedProvider {
  ...
  restoreConnection(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        (_b2 = this.analytics) === null || _b2 === void 0 ? void 0 : _b2.emitJsBridgeCall({
          js_bridge_method: "restoreConnection",
          trace_id: traceId
        });
        const connectEvent = yield this.injectedWallet.restoreConnection();
        (_c2 = this.analytics) === null || _c2 === void 0 ? void 0 : _c2.emitJsBridgeResponse({
          js_bridge_method: "restoreConnection",
          trace_id: traceId
        });
        ...
        (_d2 = this.analytics) === null || _d2 === void 0 ? void 0 : _d2.emitJsBridgeError({
          js_bridge_method: "restoreConnection",
          error_message: String(e2),
          trace_id: traceId
        });
        yield this.connectionStorage.removeConnection();
        console.error(e2);
  ...
  sendRequest(request, optionsOrOnRequestSent) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (typeof optionsOrOnRequestSent === "function") {
        ...
        options.signal = optionsOrOnRequestSent === null || optionsOrOnRequestSent === void 0 ? void 0 : optionsOrOnRequestSent.signal;
        options.attempts = optionsOrOnRequestSent === null || optionsOrOnRequestSent === void 0 ? void 0 : optionsOrOnRequestSent.attempts;
        options.traceId = (_a2 = optionsOrOnRequestSent === null || optionsOrOnRequestSent === void 0 ? void 0 : optionsOrOnRequestSent.traceId) !== null && _a2 !== void 0 ? _a2 : UUIDv7();
      }
      const id = (yield this.connectionStorage.getNextRpcRequestId()).toString();
      yield this.connectionStorage.increaseNextRpcRequestId();
      ...
      result.then((response) => {
        var _a3;
        (_a3 = this.analytics) === null || _a3 === void 0 ? void 0 : _a3.emitJsBridgeResponse({
          js_bridge_method: "send"
        });
        logDebug("Wallet message received:", response);
      }).catch((error) => {
        var _a3;
        (_a3 = this.analytics) === null || _a3 === void 0 ? void 0 : _a3.emitJsBridgeError({
          js_bridge_method: "send",
          error_message: String(error)
        });
      });
      (_c2 = options === null || options === void 0 ? void 0 : options.onRequestSent) === null || _c2 === void 0 ? void 0 : _c2.call(options);
      return result;
    });
  }
  _connect(protocolVersion, message, options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        logDebug("Injected Provider connect error:", e2);
  ...
  makeSubscriptions(options) {
    ...
    (_a2 = this.analytics) === null || _a2 === void 0 ? void 0 : _a2.emitJsBridgeCall({
    ...
    try {
      this.unsubscribeCallback = this.injectedWallet.listen((e2) => {
        var _a3;
        const traceId = (_a3 = e2.traceId) !== null && _a3 !== void 0 ? _a3 : UUIDv7();
        logDebug("Wallet message received:", e2);
        if (this.listenSubscriptions) {
          this.listeners.forEach((listener) => listener(Object.assign(Object.assign({}, e2), { traceId })));
        }
        if (e2.event === "disconnect") {
          this.disconnect({ traceId });
        }
      });
      (_b2 = this.analytics) === null || _b2 === void 0 ? void 0 : _b2.emitJsBridgeResponse({
        js_bridge_method: "listen",
        trace_id: options.traceId
      });
    } catch (err) {
      (_c2 = this.analytics) === null || _c2 === void 0 ? void 0 : _c2.emitJsBridgeError({
        js_bridge_method: "listen",
        error_message: String(err),
        trace_id: options.traceId
      });
...
function addQaModeStyles() {
  ...
  if (existingStyle)
    return;
  const style2 = document.createElement("style");
  style2.id = "ton-connect-qa-mode-styles";
  style2.textContent = `
        body.qa-mode-active {
...
var WalletsListManager = class {
  constructor(options) {
    ...
    if (isQaModeEnabled()) {
      ...
      this.walletsListSource = (_a2 = options === null || options === void 0 ? void 0 : options.walletsListSource) !== null && _a2 !== void 0 ? _a2 : "https://config.ton.org/wallets-v2.json";
    }
  ...
  fetchWalletsListFromSource() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        (_a2 = this.onDownloadDurationMeasured) === null || _a2 === void 0 ? void 0 : _a2.call(this, duration);
      } catch (e2) {
        logError(e2);
        walletsList = FALLBACK_WALLETS_LIST;
        (_b2 = this.onDownloadDurationMeasured) === null || _b2 === void 0 ? void 0 : _b2.call(this, void 0);
      }
      return walletsList;
    });
  }
...
function createConnectionInfo(version, wallet, sessionInfo) {
  var _a2, _b2, _c2, _d2, _e2, _f2, _g2, _h2, _j, _k, _l;
  ...
  return {
    ...
    wallet_state_init: (_d2 = wallet === null || wallet === void 0 ? void 0 : wallet.account.walletStateInit) !== null && _d2 !== void 0 ? _d2 : null,
    wallet_type: (_e2 = wallet === null || wallet === void 0 ? void 0 : wallet.device.appName) !== null && _e2 !== void 0 ? _e2 : null,
    wallet_version: (_f2 = wallet === null || wallet === void 0 ? void 0 : wallet.device.appVersion) !== null && _f2 !== void 0 ? _f2 : null,
    auth_type: authType,
    custom_data: Object.assign({ client_id: (_g2 = sessionInfo === null || sessionInfo === void 0 ? void 0 : sessionInfo.clientId) !== null && _g2 !== void 0 ? _g2 : null, wallet_id: (_h2 = sessionInfo === null || sessionInfo === void 0 ? void 0 : sessionInfo.walletId) !== null && _h2 !== void 0 ? _h2 : null, chain_id: (_k = (_j = wallet === null || wallet === void 0 ? void 0 : wallet.account) === null || _j === void 0 ? void 0 : _j.chain) !== null && _k !== void 0 ? _k : null, provider: (_l = wallet === null || wallet === void 0 ? void 0 : wallet.provider) !== null && _l !== void 0 ? _l : null }, createVersionInfo(version))
  };
}
...
function createConnectionErrorEvent(version, error_message, errorCode, sessionInfo, traceId) {
  ...
  return {
    ...
    trace_id: traceId !== null && traceId !== void 0 ? traceId : null,
    custom_data: Object.assign({ client_id: (_a2 = sessionInfo === null || sessionInfo === void 0 ? void 0 : sessionInfo.clientId) !== null && _a2 !== void 0 ? _a2 : null, wallet_id: (_b2 = sessionInfo === null || sessionInfo === void 0 ? void 0 : sessionInfo.walletId) !== null && _b2 !== void 0 ? _b2 : null }, createVersionInfo(version))
  };
}
...
function createTransactionInfo(wallet, transaction) {
  var _a2, _b2, _c2, _d2;
  return {
    valid_until: (_a2 = String(transaction.validUntil)) !== null && _a2 !== void 0 ? _a2 : null,
    from: (_d2 = (_b2 = transaction.from) !== null && _b2 !== void 0 ? _b2 : (_c2 = wallet === null || wallet === void 0 ? void 0 : wallet.account) === null || _c2 === void 0 ? void 0 : _c2.address) !== null && _d2 !== void 0 ? _d2 : null,
    messages: transaction.messages.map((message) => {
      var _a3, _b3;
      return {
        address: (_a3 = message.address) !== null && _a3 !== void 0 ? _a3 : null,
        amount: (_b3 = message.amount) !== null && _b3 !== void 0 ? _b3 : null
      };
    })
  };
}
  ...
  return {
    ...
    messages: transaction.messages.map((message) => {
      ...
      return {
        address: (_a3 = message.address) !== null && _a3 !== void 0 ? _a3 : null,
        amount: (_b3 = message.amount) !== null && _b3 !== void 0 ? _b3 : null,
        payload: (_c3 = message.payload) !== null && _c3 !== void 0 ? _c3 : null,
        state_init: (_d3 = message.stateInit) !== null && _d3 !== void 0 ? _d3 : null
      };
    })
  };
}
...
function createSelectedWalletEvent(version, visibleWallets, lastSelectedWallet, walletsMenu, redirectLink, redirectLinkType, clientId, traceId) {
  ...
  return {
    ...
    wallet_type: (_a2 = lastSelectedWallet === null || lastSelectedWallet === void 0 ? void 0 : lastSelectedWallet.appName) !== null && _a2 !== void 0 ? _a2 : null
  };
}
...
var tonConnectSdkVersion = "3.4.1";
...
function parseUserFriendlyAddress(address) {
  ...
  if (!checksum.every((byte, i2) => byte === calculatedChecksum[i2])) {
...
function validateSendTransactionRequest(data) {
  ...
  for (let i2 = 0; i2 < data.messages.length; i2++) {
    const message = data.messages[i2];
    const messageError = validateTransactionMessage(message, i2);
    if (messageError) {
      return messageError;
    }
  }
...
var AnalyticsManager = class _AnalyticsManager {
  constructor(options = {}) {
    ...
    this.batchTimeoutMs = (_a2 = options.batchTimeoutMs) !== null && _a2 !== void 0 ? _a2 : 2e3;
    this.currentBatchTimeoutMs = this.batchTimeoutMs;
    this.maxBatchSize = (_b2 = options.maxBatchSize) !== null && _b2 !== void 0 ? _b2 : 100;
    this.analyticsUrl = (_c2 = options.analyticsUrl) !== null && _c2 !== void 0 ? _c2 : "https://analytics.ton.org/events";
    this.mode = (_d2 = options.mode) !== null && _d2 !== void 0 ? _d2 : "telemetry";
    this.baseEvent = Object.assign({ subsystem: "dapp-sdk", version: tonConnectSdkVersion, client_environment: (_f2 = (_e2 = options.environment) === null || _e2 === void 0 ? void 0 : _e2.getClientEnvironment) === null || _f2 === void 0 ? void 0 : _f2.call(_e2) }, getStaticConnectionMetrics());
  ...
  emit(event) {
    ...
    const traceId = (_a2 = event.trace_id) !== null && _a2 !== void 0 ? _a2 : UUIDv7();
  ...
  addWindowFocusAndBlurSubscriptions() {
    ...
    try {
      ...
      logError("Cannot subscribe to the document.visibilitychange: ", e2);
    }
  }
  getMode() {
    return this.mode;
...
function buildTonConnectEvent(detail) {
  ...
  return {
    ...
    network_id: (_a2 = detail.custom_data.chain_id) !== null && _a2 !== void 0 ? _a2 : "",
    client_id: (_b2 = detail.custom_data.client_id) !== null && _b2 !== void 0 ? _b2 : "",
    wallet_id: (_c2 = detail.custom_data.wallet_id) !== null && _c2 !== void 0 ? _c2 : "",
    wallet_address: (_d2 = detail.wallet_address) !== null && _d2 !== void 0 ? _d2 : "",
    wallet_app_name: (_e2 = detail.wallet_type) !== null && _e2 !== void 0 ? _e2 : "",
    wallet_app_version: (_f2 = detail.wallet_version) !== null && _f2 !== void 0 ? _f2 : "",
    wallet_state_init: (_g2 = detail.wallet_state_init) !== null && _g2 !== void 0 ? _g2 : "",
    trace_id: (_h2 = detail.trace_id) !== null && _h2 !== void 0 ? _h2 : void 0
  };
}
function bindEventsTo(eventDispatcher, analytics) {
  eventDispatcher.addEventListener("ton-connect-ui-wallet-modal-opened", (event) => {
    ...
    analytics.emitConnectionStarted({
      ...
      trace_id: (_a2 = detail.trace_id) !== null && _a2 !== void 0 ? _a2 : void 0
    });
  });
  eventDispatcher.addEventListener("ton-connect-ui-selected-wallet", (event) => {
    ...
    analytics.emitConnectionSelectedWallet({
      ...
      trace_id: (_a2 = detail.trace_id) !== null && _a2 !== void 0 ? _a2 : void 0,
      wallet_app_name: (_b2 = detail.wallet_type) !== null && _b2 !== void 0 ? _b2 : "",
  ...
  eventDispatcher.addEventListener("ton-connect-connection-error", (event) => {
    ...
    analytics.emitConnectionError({
      ...
      error_code: (_a2 = detail.error_code) !== null && _a2 !== void 0 ? _a2 : 0,
      error_message: detail.error_message,
      trace_id: (_b2 = detail.trace_id) !== null && _b2 !== void 0 ? _b2 : void 0
    });
  });
  ...
  eventDispatcher.addEventListener("ton-connect-transaction-signing-failed", (event) => {
    ...
    analytics.emitTransactionSigningFailed(Object.assign(Object.assign({}, buildTonConnectEvent(detail)), { valid_until: Number(detail.valid_until), messages: detail.messages.map((message) => {
      var _a3, _b2, _c2, _d2;
      return {
        address: (_a3 = message.address) !== null && _a3 !== void 0 ? _a3 : "",
        amount: (_b2 = message.amount) !== null && _b2 !== void 0 ? _b2 : "",
        payload: (_c2 = message.payload) !== null && _c2 !== void 0 ? _c2 : "",
        state_init: (_d2 = message.state_init) !== null && _d2 !== void 0 ? _d2 : ""
      };
    }), error_message: detail.error_message, error_code: (_a2 = detail.error_code) !== null && _a2 !== void 0 ? _a2 : 0 }));
  });
  ...
  eventDispatcher.addEventListener("ton-connect-sign-data-request-failed", (event) => {
    ...
    analytics === null || analytics === void 0 ? void 0 : analytics.emitSignDataRequestFailed(Object.assign(Object.assign({}, buildTonConnectEvent(detail)), { sign_data_type: detail.data.type, sign_data_value: signDataValue, sign_data_schema: signDataSchema, error_code: (_a2 = detail.error_code) !== null && _a2 !== void 0 ? _a2 : 0, error_message: detail.error_message }));
  });
}
...
var WalletConnectProvider = class _WalletConnectProvider {
  ...
  _connect(message, options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if ((_b2 = options.signal) === null || _b2 === void 0 ? void 0 : _b2.aborted) {
  ...
  disconnect(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        yield (_b2 = this.connector) === null || _b2 === void 0 ? void 0 : _b2.disconnect();
      } catch (error) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (request.method === "sendTransaction") {
          const _e2 = JSON.parse(request.params[0]), { network } = _e2, sendTransactionPayload = __rest(_e2, ["network"]);
          ...
          const _f2 = JSON.parse(request.params[0]), { network } = _f2, signDataPayload = __rest(_f2, ["network"]);
          const promise = this.connector.request({
            method: "ton_signData",
            params: signDataPayload
          }, `ton:${network}`);
          (_d2 = options === null || options === void 0 ? void 0 : options.onRequestSent) === null || _d2 === void 0 ? void 0 : _d2.call(options);
          const result = yield promise;
          logDebug("Wallet message received:", { result, id: DEFAULT_REQUEST_ID });
  ...
  buildTonProof(connector) {
    var _a2, _b2, _c2;
    const auth = (_a2 = connector.provider.session.authentication) === null || _a2 === void 0 ? void 0 : _a2[0];
    const iat = (_b2 = auth === null || auth === void 0 ? void 0 : auth.p) === null || _b2 === void 0 ? void 0 : _b2.iat;
    const statement = (_c2 = auth === null || auth === void 0 ? void 0 : auth.p) === null || _c2 === void 0 ? void 0 : _c2.statement;
    if (!iat || !statement) {
      return;
    }
  ...
  onConnect(connector, options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!((_b2 = tonNamespace === null || tonNamespace === void 0 ? void 0 : tonNamespace.accounts) === null || _b2 === void 0 ? void 0 : _b2[0])) {
      ...
      const publicKey = (_c2 = session.sessionProperties) === null || _c2 === void 0 ? void 0 : _c2.ton_getPublicKey;
      if (!publicKey) {
        yield this.disconnectWithError({
          traceId: options.traceId,
          code: CONNECT_EVENT_ERROR_CODES.BAD_REQUEST_ERROR,
      ...
      const stateInit = (_d2 = session.sessionProperties) === null || _d2 === void 0 ? void 0 : _d2.ton_getStateInit;
      if (!stateInit) {
        yield this.disconnectWithError({
          traceId: options.traceId,
          code: CONNECT_EVENT_ERROR_CODES.BAD_REQUEST_ERROR,
...
var TonConnect = class {
  ...
  constructor(options) {
    ...
    this.environment = (_a2 = options === null || options === void 0 ? void 0 : options.environment) !== null && _a2 !== void 0 ? _a2 : new DefaultEnvironment();
    this.walletsList = new WalletsListManager({
      walletsListSource: options === null || options === void 0 ? void 0 : options.walletsListSource,
      cacheTTLMs: options === null || options === void 0 ? void 0 : options.walletsListCacheTTLMs,
      onDownloadDurationMeasured: (duration) => {
        var _a3;
        (_a3 = this.analytics) === null || _a3 === void 0 ? void 0 : _a3.setWalletListDownloadDuration(duration);
      }
    });
    const eventDispatcher = (_b2 = options === null || options === void 0 ? void 0 : options.eventDispatcher) !== null && _b2 !== void 0 ? _b2 : new BrowserEventDispatcher();
    this.tracker = new TonConnectTracker({
      eventDispatcher,
      tonConnectSdkVersion
    });
    this.environment = (_c2 = options === null || options === void 0 ? void 0 : options.environment) !== null && _c2 !== void 0 ? _c2 : new DefaultEnvironment();
  ...
  connect(wallet, requestOrOptions, additionalOptions) {
    ...
    const traceId = (_c2 = options === null || options === void 0 ? void 0 : options.traceId) !== null && _c2 !== void 0 ? _c2 : UUIDv7();
  ...
  restoreConnection(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      (_c2 = this.provider) === null || _c2 === void 0 ? void 0 : _c2.closeConnection();
  ...
  sendTransaction(transaction, optionsOrOnRequestSent) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (((_b2 = this.wallet) === null || _b2 === void 0 ? void 0 : _b2.account.chain) && network !== this.wallet.account.chain) {
        if (!isQaModeEnabled()) {
          throw new WalletWrongNetworkError("Wallet connected to a wrong network", {
            cause: {
              expectedChainId: (_c2 = this.wallet) === null || _c2 === void 0 ? void 0 : _c2.account.chain,
              actualChainId: network
            }
          });
        }
        console.error("Wallet connected to a wrong network", {
          expectedChainId: (_d2 = this.wallet) === null || _d2 === void 0 ? void 0 : _d2.account.chain,
          actualChainId: network
        });
      }
      const response = yield this.provider.sendRequest(sendTransactionParser.convertToRpcRequest(Object.assign(Object.assign({}, tx), {
        ...
        messages: messages.map((_a3) => {
          var { extraCurrency, payload, stateInit } = _a3, msg = __rest(_a3, ["extraCurrency", "payload", "stateInit"]);
  ...
  disconnect(options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield (_b2 = this.provider) === null || _b2 === void 0 ? void 0 : _b2.disconnect({
        signal: abortController.signal,
        traceId
      });
  ...
  initAnalytics(manifestUrl, eventDispatcher, options) {
    ...
    const mode = (_a2 = analyticsSettings === null || analyticsSettings === void 0 ? void 0 : analyticsSettings.mode) !== null && _a2 !== void 0 ? _a2 : "telemetry";
    if (mode === "off") {
      return;
    }
    ...
    const telegramUser2 = this.environment.getTelegramUser();
    ...
    if (telegramUser2) {
      sharedAnalyticsData.tg_id = telegramUser2.id;
      sharedAnalyticsData.tma_is_premium = telegramUser2.isPremium;
    }
  ...
  walletEventsListener(e2) {
    switch (e2.event) {
      case "connect":
        this.onWalletConnected(e2.payload, { traceId: e2.traceId });
        break;
      case "connect_error":
        this.tracker.trackConnectionError(e2.payload.message, e2.payload.code, this.getSessionInfo(), e2.traceId);
        const walletError = connectErrorsParser.parseError(e2.payload);
        this.onWalletConnectError(walletError);
        break;
      case "disconnect":
        this.onWalletDisconnected("wallet", { traceId: e2.traceId });
    }
  }
  onWalletConnected(connectEvent, options) {
    ...
    if (!hasRequiredFeatures) {
      (_a2 = this.provider) === null || _a2 === void 0 ? void 0 : _a2.disconnect();
    ...
    if (this.desiredChainId && wallet.account.chain !== this.desiredChainId) {
      ...
      (_b2 = this.provider) === null || _b2 === void 0 ? void 0 : _b2.disconnect();
...
function createResource2(pSource, pFetcher, pOptions) {
  let source;
  let fetcher;
  let options;
  {
...
function children(fn) {
  ...
  const memo22 = createMemo(() => resolveChildren(children2()));
  memo22.toArray = () => {
    const c2 = memo22();
...
var InMemoryStorage2 = class _InMemoryStorage {
  constructor() {
    this.storage = {};
  }
  static getInstance() {
...
function openLink(href, target = "_self") {
  ...
  logDebug2("openLink", href, target);
...
var WalletInfoStorage = class {
  constructor() {
    ...
    this.localStorage = tryGetLocalStorage2();
  }
...
var getSingleWalletModalIsOpened = createMemo(
...
function sessionStorageSet(key, value) {
  ...
  try {
    ...
    return (_a2 = window2 == null ? void 0 : window2.sessionStorage) == null ? void 0 : _a2.setItem(key, value);
  } catch (e2) {
  }
}
function sessionStorageGet(key) {
  ...
  try {
    const window2 = getWindow$1();
    return JSON.parse((_b2 = (_a2 = window2 == null ? void 0 : window2.sessionStorage) == null ? void 0 : _a2.getItem) == null ? void 0 : _b2.call(_a2, key));
  } catch (e2) {
  }
  return null;
}
function updateFromStoredParams(key) {
  try {
    const storedParams = sessionStorageGet(key);
    if (storedParams) {
      for (const key2 in storedParams) {
        if (typeof initParams[key2] === "undefined") {
          initParams[key2] = storedParams[key2];
        }
      }
    }
  } catch (e2) {
...
function updateFromStoredRawParams(key) {
  var _a2, _b2;
  try {
    const window2 = getWindow$1();
    let raw = (_b2 = (_a2 = window2 == null ? void 0 : window2.sessionStorage) == null ? void 0 : _a2.getItem) == null ? void 0 : _b2.call(_a2, key);
    if (!raw) {
      return;
    }
    try {
...
var LAUNCH_PARAMS_STORAGE_KEY = "ton-connect-session_storage_launchParams";
...
var initDataRaw = initParams == null ? void 0 : initParams.tgWebAppData;
var telegramUser = void 0;
try {
  if (initDataRaw) {
...
function postEvent(eventType, eventData) {
  try {
    ...
    if (window2.TelegramWebviewProxy !== void 0) {
      logDebug2("postEvent", eventType, eventData);
    ...
    logError2(`Can't post event to parent window: ${e2}`);
  }
}
...
function resolveElements(fn, predicate = defaultElementPredicate, serverPredicate = defaultElementPredicate) {
  const children2 = createMemo(fn);
  const memo22 = createMemo(() => getResolvedElements(children2(), predicate));
  memo22.toArray = () => {
    const value = memo22();
...
var _AnimationNoop = class _AnimationNoop2 {
  constructor() {
    this.currentTime = 0;
    this.playbackRate = 1;
    this.startTime = null;
...
var qrcode = getDefaultExportFromCjs(qrcodeExports);
...
var _tmpl$2$3 = template$1(`<svg xmlns=http://www.w3.org/2000/svg width=48 height=48 viewBox="0 0 48 48"fill=none><circle cx=24 cy=24.001 r=22></circle><path d="M24 24.001L31.5 16.501M24 24.001L16.5 16.501M24 24.001L16.5 31.501M24 24.001L31.5 31.501"stroke-width=3 stroke-linecap=round stroke-linejoin=round>`);
...
var _tmpl$3 = template$1(`<svg width=72 height=72 viewBox="0 0 72 72"fill=none xmlns=http://www.w3.org/2000/svg><path d="M24 56.7846C35.479 63.412 50.1572 59.479 56.7846 47.9999C63.412 36.5209 59.479 21.8427 48 15.2153C36.521 8.58791 21.8428 12.5209 15.2154 23.9999"stroke-width=4 stroke-linecap=round stroke-linejoin=round>`);
var LoaderIcon = (props) => {
  ...
  return memo(() => memo(() => size() === "xs")() ? (() => {
    ...
    createRenderEffect((_p$) => {
      var _v$ = (0, import_classnames.default)(svgClass, props.class), _v$2 = fill();
      _v$ !== _p$.e && setAttribute(_el$, "class", _p$.e = _v$);
      _v$2 !== _p$.t && setAttribute(_el$2, "fill", _p$.t = _v$2);
      return _p$;
    }, {
    ...
    createRenderEffect((_p$) => {
      var _v$3 = (0, import_classnames.default)(svgClass, props.class), _v$4 = fill();
    ...
    createRenderEffect((_p$) => {
      var _v$5 = (0, import_classnames.default)(svgClass, props.class), _v$6 = fill();
...
var ErrorIconStyled$4 = styled(ErrorIcon)`
    margin-top: 2px;
`;
...
function useOpenedNotifications(config) {
  const { timeout: timeout2 } = __spreadValues(__spreadValues({}, defaultConfig), config);
...
var ErrorIconStyled$3 = styled(ErrorIcon)`
    margin-top: 2px;
`;
var ErrorSignDataNotification = (props) => {
  return createComponent(Notification, {
    header: {
...
var SuccessSignDataNotification = (props) => {
  return createComponent(Notification, {
    header: {
...
var _tmpl$$5 = template$1(`<div data-tc-list-notifications=true>`);
  ...
  return {
    ...
    fn(state2) {
      return __async(this, null, function* () {
        ...
        const _a3 = evaluate(options, state2), {
...
var _tmpl$$4 = template$1(`<tc-root data-tc-dropdown-container=true>`, true, false, false);
var AccountButton = () => {
  const theme = useTheme();
...
styled(Button)`
    ...
    font-size: 15px;
`;
var StyledIconButton$5 = styled(IconButton)`
    position: absolute;
    top: 16px;
    left: 16px;
`;
...
var WALLET_CONNECT_APP_NAME = "wallet_connect";
var WALLET_CONNECT_WALLET_NAME = "WalletConnect";
var WALLET_CONNECT_ABOUT_URL = "https://reown.com/";
var _tmpl$$2 = template$1(`<li>`);
...
var H2Styled$4 = styled(H2)`
    ...
    margin: 0 auto 20px;
`;
var StyledIconButton$4 = styled(IconButton)`
    position: absolute;
    top: 16px;
    left: 16px;
`;
var ButtonsContainerStyled$2 = styled.div`
    display: flex;
    justify-content: center;
    gap: 8px;
    padding-bottom: 16px;
`;
var BottomButtonsContainerStyled = styled(ButtonsContainerStyled$2)`
    padding-bottom: 0;
`;
...
var ErrorIconStyled$2 = styled(ErrorIcon)`
    margin-bottom: 16px;
`;
var BodyTextStyled$2 = styled(H2)`
    color: ${(props) => props.theme.colors.text.secondary};
    text-align: center;
    margin-bottom: 20px;
`;
...
var _tmpl$$1 = template$1(`<li>`);
var _tmpl$2 = template$1(`<div data-tc-wallets-modal-universal-mobile=true>`);
...
var H1Styled$2 = styled(H1)`
    ...
    margin: 0 auto 38px;
`;
var DesktopFeatureNotSupportModalStyled = styled.div`
    display: flex;
    flex-direction: column;
    align-items: center;
`;
...
var TitleStyled = styled(H1)`
    ...
    line-height: 28px;
`;
var DescriptionStyled = styled(Text)`
    margin-top: 12px;
    margin-bottom: 24px;
    text-align: center;
    max-width: 360px;
...
styled.ul`
    ...
    padding: 0;
`;
var DisconnectButtonStyled = styled(Button)`
    max-width: 320px;
    width: 100%;
    height: 48px;
    font-size: 16px;
...
var ButtonsContainerStyled = styled.div`
    ...
    padding-bottom: 31px;
`;
var RestoreInfoModalStyled = styled.div`
...
var DesktopFeatureNotSupportModal = (props) => {
...
var WalletsModal = () => {
  ...
  const [fetchedWalletsList, {
    ...
    return tonConnectUI2.getWallets();
  });
  ...
  const walletsModalIsWalletNotSupportFeature = createMemo(() => {
    ...
    return "type" in state2 && state2.type === "wallet-not-support-feature";
  });
  const walletsList = createMemo(() => {
    ...
    const walletsFeaturesRequested = (_a2 = tonConnectUI2 == null ? void 0 : tonConnectUI2.walletsRequiredFeatures) != null ? _a2 : tonConnectUI2 == null ? void 0 : tonConnectUI2.walletsPreferredFeatures;
                  ...
                  return [createComponent(Match, {
                    ...
                    get children() {
                      return createComponent(DesktopFeatureNotSupportModal, {
                        ...
                        get currentWallet() {
                          return tonConnectUI2 == null ? void 0 : tonConnectUI2.wallet;
                        },
                    ...
                    get children() {
                      return createComponent(AllWalletsListModal, {
                        ...
                        get featureCheckMode() {
                          return (tonConnectUI2 == null ? void 0 : tonConnectUI2.walletsRequiredFeatures) ? "strict" : "soft";
                        },
...
var ConfirmSignDataModal = (props) => {
  const tonConnectUI2 = useContext(TonConnectUiContext);
  const [t2] = useI18n();
  const name = () => tonConnectUI2.wallet && "name" in tonConnectUI2.wallet ? tonConnectUI2.wallet.name : t2("common.yourWallet", {}, "Your wallet");
  return createComponent(ActionModal, {
...
var SignDataCanceledModal = (props) => {
  return createComponent(ActionModal, {
  ...
  setRequestVersionHandler() {
    return __async(this, null, function* () {
      yield this.eventDispatcher.addEventListener("ton-connect-ui-request-version", () => __async(this, null, function* () {
        var _a2;
        let response = createResponseVersionEvent(
          this.tonConnectUiVersion
        );
        try {
          const ua = getUserAgent();
          response = __spreadProps(__spreadValues({}, response), {
            tma: isInTMA(),
            ...
            os: ua.os,
            browser: ua.browser,
            rawBrowser: (_a2 = new import_ua_parser_js.default().getBrowser().name) != null ? _a2 : null,
...
var tonConnectUiVersion = "2.4.4";
var TonConnectEnvironment = class {
  constructor() {
...
var TonConnectUIProvider = (_a2) => {
  var _b2 = _a2, {
    children: children2
  } = _b2, options = __objRest2(_b2, [
    "children"
  ]);
  const [uiInstance] = (0, import_react.useState)(() => {
    if (!isClientSide()) {
      return null;
    }
  ...
  return (0, import_jsx_runtime.jsx)(TonConnectUIContext.Provider, { value: uiInstance, children: children2 });
};
...
function useTonConnectModal() {
  const [tonConnectUI2] = useTonConnectUI();
  const [state2, setState] = (0, import_react.useState)((tonConnectUI2 == null ? void 0 : tonConnectUI2.modal.state) || null);
  (0, import_react.useEffect)(() => {
    if (tonConnectUI2) {
